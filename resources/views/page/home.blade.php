        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                <div class="product d-flex flex-column">
                    <a href="{{route('product_single',$new->id)}}" class="img-prod"><img class="img-fluid" src="{{Voyager::image($img)}}"
                    ...
                    <div class="text py-3 pb-4 px-3">
                        ...
                        <p class="bottom-area d-flex px-3">
                            <a href="{{route('themgiohang',$new->id)}}" class="add-to-cart text-center py-2 mr-1"><span>Add to cart <i
